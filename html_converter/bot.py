...
<a href="https://t.me/Contact_AdminS2bot" style="text-decoration: none; color: inherit;">
  <i class="fas fa-bolt"></i> Team_Sonu1 <i class="fas fa-bolt"></i>
</a>
...
<a href="https://t.me/Contact_AdminS2bot" style="text-decoration: none; color: inherit;">
  <span class="badge bg-primary me-2">
    <i class="fas fa-robot"></i> Join @BotChatAll
  </span>
</a>

            <a href="http://t.me/Contact_AdminS2bot" class="text-decoration-none">
                <span class="badge bg-warning">
                    <i class="fas fa-bolt"></i>ST
                </span>
            </a>
        </p>
    </div>
    ...
    pdf_links = "".join(
        ...
        f'<button class="btn-action download" onclick="downloadFile(\'{obfuscate_url(url)}\', \'{name} - @Team_Sonu1.pdf\')" title="Download PDF">'
...
async def handle_txt2html(client: Client, message: Message):
    ...
    try:
        ...
        html_file_name = f"{base_name}_@Team_Sonu1.html"
